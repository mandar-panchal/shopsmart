...
<div class="invoice-print p-3">
  ...
  <table class="table">
    <thead>
      <tr>
        <!-- Add 10 new columns -->
        <th class="py-1">Column 1</th>
        <th class="py-1">Column 2</th>
        <th class="py-1">Column 3</th>
        <th class="py-1">Column 4</th>
        <th class="py-1">Column 5</th>
        <th class="py-1">Column 6</th>
        <th class="py-1">Column 7</th>
        <th class="py-1">Column 8</th>
        <th class="py-1">Column 9</th>
        <th class="py-1">Column 10</th>
        <!-- End of new columns -->
    ...
    <tbody>
      <tr>
        ...
        <td class="py-1">
          <span class="fw-bold">Data 1</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 2</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 3</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 4</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 5</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 6</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 7</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 8</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 9</span>
        </td>
        <td class="py-1">
          <span class="fw-bold">Data 10</span>
        </td>
        <!-- End of dummy data -->
        <td class="py-1">
