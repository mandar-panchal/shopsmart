...
<div class="navbar-container d-flex content">
  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
    ...
    {{-- <li class="nav-item d-none d-lg-block"><a class="nav-link nav-link-style" id="themeToggle"><i class="ficon"
          data-feather="{{ $theme === 'dark' ? 'sun' : 'moon' }}"></i></a></li> --}}
   ...
   {{-- Search. --}}
    {{-- <li class="nav-item nav-search"><a class="nav-link nav-link-search"><i class="ficon"
      ...
      <div class="search-input">
        ...
        <input class="form-control input" type="text" placeholder="Explore {{ config('app.name') }}..." tabindex="-1" data-search="search">
    ...
    @can('tb_incomming_calls')
    <li class="nav-item dropdown dropdown-cart me-25">
      <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
        <i class="ficon" data-feather="phone"></i>
        <span class="badge rounded-pill bg-danger badge-up cart-item-count">3</span>
      </a>
    </li>
    @endcan
    {{-- /Incomming calls--}}
    ...
    <li class="nav-item dropdown dropdown-cart me-25">
      <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
        ...
        <span class="badge rounded-pill bg-primary badge-up cart-item-count">4</span>
      </a>
      <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
        <li class="dropdown-menu-header">
          <div class="dropdown-header d-flex">
            <h4 class="notification-title mb-0 me-auto">Pop up</h4>
            <div class="badge rounded-pill badge-light-primary">4 Items</div>
          </div>
        </li>
        <li class="scrollable-container media-list">
          <a class="d-flex" href="/patient/details">
            <div class="list-item d-flex align-items-start">
              ...
              <div class="list-item-body flex-grow-1">
                <p class=""><span class="fw-bolder">New popup added to system</span></p>
              </div>
            </div>
          </a>
          <a class="d-flex" href="/patient/details">
...
@can('tb_notification')
    ...
    <li class="nav-item dropdown dropdown-notification me-25">
      ...
      <a class="nav-link" id="notificationdiv" href="javascript:void(0);" data-bs-toggle="dropdown">
