...
$(function () {
  ...
  if (dataTablePermissions.length) {
    dt_permission = dataTablePermissions.DataTable({
      ajax: {
        url: '/get-permissions', // Adjust the route to your controller method
        type: 'GET',
        dataSrc: 'data',
    },
          ...
          render: function (data, type, full, meta) {
            ...
            var roleBadgeObj = {
              ...
              Teamleader:
                '<a href="' +
                userList +
                '" class="me-50"><span class="badge rounded-pill badge-light-warning">Team Leader</span></a>',
              Telecaller:
                '<a href="' +
                userList +
                '" class="me-50"><span class="badge rounded-pill badge-light-success">Telecaller</span></a>',
              Support:
                '<a href="' +
                userList +
