  ...
  if (lineChartEx.length) {
    var lineExample = new Chart(lineChartEx, {
      ...
      data: {
        ...
        datasets: [
          {
            data: [73, 64, 71, 76, 72, 70, 69, 63, 65, 78, 77, 73],
            label: 'Nashik',
          ...
          {
            data: [45, 52, 56, 52, 57, 58, 42, 53, 47, 51, 53, 61],
            label: 'Pune',
          ...
          {
            data: [43, 42, 40, 39, 43, 43, 41, 52, 46, 47, 53, 56],
            label: 'Thane',
            borderColor: '#f59b42',
            lineTension: 0.5,
            pointStyle: 'circle',
            ...
            pointBorderColor: 'transparent',
            pointHoverBorderColor: window.colors.solid.white,
            pointHoverBackgroundColor: '#f59b42',
            pointShadowOffsetX: 1,
            pointShadowOffsetY: 1,
            pointShadowBlur: 5,
            pointShadowColor: tooltipShadow
          ...
          {
            data: [22, 15, 26, 31, 11, 13, 23, 25, 31, 27, 22, 29],
            label: 'Panvel',
            borderColor: '#57d968',
            lineTension: 0.5,
            pointStyle: 'circle',
            backgroundColor: '#57d968',
            fill: false,
            pointRadius: 1,
            pointHoverRadius: 5,
            pointHoverBorderWidth: 5,
            pointBorderColor: 'transparent',
            pointHoverBorderColor: window.colors.solid.white,
            pointHoverBackgroundColor: '#57d968',
            pointShadowOffsetX: 1,
            pointShadowOffsetY: 1,
            pointShadowBlur: 5,
            pointShadowColor: tooltipShadow
