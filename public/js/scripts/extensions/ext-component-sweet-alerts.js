...
function showSweetAlert(title, text, callback) {
  Swal.fire({
    ...
    // Call the callback function after the user clicks "OK"
...
function showSweetAlertError(title, text, callback) {
 // Error
    Swal.fire({
      title: title,
      text: text,
...
// Warning
function showSweetAlertWarning(title, text, callback) {
    Swal.fire({
      title: title,
      text: text,
      icon: 'warning',
...
// Info
function showSweetAlertInfo(title, text, callback) {
    Swal.fire({
      title: title,
      text: text,
      icon: 'info',
...
$(function () {
  ...
  if (success.length) {
    success.on('click', function () {
      Swal.fire({
        title: 'Done!',
        text: 'Successfully change the role!',
        icon: 'success',
        customClass: {
          confirmButton: 'btn btn-primary'
        },
