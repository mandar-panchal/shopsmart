...
$(function () {
  ...
  if (dataTablePermissions.length) {
    dt_permission = dataTablePermissions.DataTable({
      ajax: {
        url: '/authorization/permission/getdata', // Adjust the route to your controller method
        type: 'GET',
        dataSrc: 'data',
    },
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
              var $output = '';
              var roleBadgeObj = {
                  superadmin: '<span class="badge rounded-pill badge-light-info">Super Admin</span>',
                  admin: '<span class="badge rounded-pill badge-light-primary">Administrator</span>',
                  teamleader: '<span class="badge rounded-pill badge-light-warning">Teamleader</span>',
                  telecaller: '<span class="badge rounded-pill badge-light-success">Telecaller</span>',                  
                  Restricted: '<span class="badge rounded-pill badge-light-danger">Restricted User</span>'
              };
      
              // Assuming 'roles' is an array of role names associated with the permission
              var roles = full.roles || [];
      
              // Render badges based on roles from the database
...

        {
          ...
          orderable: false,
          render: function (data, type, full, meta) {
              var permissionId = full.id; // Assuming 'id' is the property containing the permission ID
      
              return (
                  '<button class="btn btn-sm btn-icon btn-edit-permission" ' +
                  'data-permission-id="' + permissionId + '" ' + // Set the data-permission-id attribute
