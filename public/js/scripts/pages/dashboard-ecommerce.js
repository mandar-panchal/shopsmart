...
$(window).on('load', function () {
  ...
  earningsChartOptions = {
    ...
    series: [5, 16, 1, 5, 10, 902, 4, 50, 103, 7, 30, 89, 87, 3],
    legend: { show: false },
    comparedResult: [2, -3, 8],
    labels: ['Referral', 'Outreach OPD', 'Camp & Event', 'Native', 'Website', 'Digital Marketing', 'Self', 'GEC', 'News Channel', 'Movies', 'OTT', 'Newspaper', 'Incoming Calls', 'Other'],
    stroke: { width: 0 },
    colors: [$earningsStrokeColor2, $earningsStrokeColor3,'#fcba03', '#fc3503', '#fc6b03','#03bafc','#03fc2c','#6203fc','#cc29b6','#cc296d','#29c9cc','#67cc29','#2e332b','#c5e8b0', window.colors.solid.success],
    grid: {
      padding: {
        right: -20,
        bottom: -8,
